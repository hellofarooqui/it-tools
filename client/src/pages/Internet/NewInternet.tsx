    ...
    <div>
      ...
      <div className="p-8">
        <div className="w-[800px] bg-white p-6 rounded-[10px] shadow-sm">
          <form onSubmit={handleSubmit} onReset={handleReset} className="grid grid-cols-[150px_auto] items-center gap-x-4 gap-y-4">
            <label className="text-sm text-end font-medium text-gray-700">Name</label>
            <input
              type="text"
            ...
            <label className="text-sm text-end font-medium text-gray-700"> IP Address</label>
            <input
              type="text"
            ...
            <label className="text-sm text-end font-medium text-gray-700">Subnet Mask</label>
            <input
              type="text"
              ...
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Gateway</label>
            <input
              type="text"
              ...
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Account Number</label>
            <input
              type="text"
              value={newInternet.accountNumber || ""}
              onChange={(e) =>
                setNewInternet({ ...newInternet, accountNumber: e.target.value })
              }
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Account Name</label>
            <input
              type="text"
              ...
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Provider</label>
            <input
              type="text"
              ...
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Bandwidth</label>
            <input
              type="text"
              ...
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Connection Type</label>
            <input
              type="text"
              value={newInternet.connectionType || ""}
              onChange={(e) =>
                setNewInternet({ ...newInternet, connectionType: e.target.value })
              }
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Account Username</label>
            <input
              type="text"
              value={newInternet.accountUsername || ""}
              onChange={(e) =>
                setNewInternet({ ...newInternet, accountUsername: e.target.value })
              }
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />
            <label className="text-sm text-end font-medium text-gray-700">Account Password</label>
            <input
              type="text"
              value={newInternet.accountPassword || ""}
              onChange={(e) =>
                setNewInternet({ ...newInternet, accountPassword: e.target.value })
              }
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />

            <label className="text-sm text-end font-medium text-gray-700">Support Contact</label>
            <input
              type="text"
              value={newInternet.supportContact || ""}
              onChange={(e) =>
                setNewInternet({ ...newInternet, supportContact: e.target.value })
              }
              className="flex-1 border border-slate-300 rounded-sm px-2 py-1"
            />

            <label className="text-sm text-end font-medium text-gray-700">Support Email</label>
            <input
              type="text"
            ...
            <label className="text-sm text-end font-medium text-gray-700">Support Phone</label>
            <input
              type="text"

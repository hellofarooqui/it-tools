...
const useSupportTicket = () => {
  ...
  const getAllSupportTicketsList = async () => {
    ...
    const updateSupportTicket = async (ticketId : {ticketId: string}, ticketData: SupportTicket) => {
        try {
    ...
    const addCommentToSupportTicket = async (ticketId : {ticketId: string}, commentData: { user: string; comment: string; }) => {
        try {
            const response = await axios.post(`${API_URL}/${ticketId}/comments`, commentData);
            return response.data;
        } catch (error) {
    ...
    const deleteCommentFromSupportTicket = async (ticketId : {ticketId: string}, commentId : {commentId: string}) => {
        try {
    ...
    const updateCommentOnSupportTicket = async (ticketId : {ticketId: string}, commentId : {commentId: string}, commentData: { user: string; comment: string; }) => {
        try {
    ...
    const getCommentsForSupportTicket = async (ticketId : {ticketId: string}) => {
        try {
